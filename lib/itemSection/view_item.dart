...
class _ViewItemState extends State<ViewItem> {
  ...
  void initState() {
    ...
    fireRef.collection('Items').doc('${widget.card.date}').get().then((value) {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    0, 4, 0, 0),
                                child: widget.card.description == null
                                    ? Container()
                                    : Text(
                  ...
                  onTap: () {
                    showDialog(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            title: Text(
                              'You will need to refill the fields',
                              style: GoogleFonts.poppins(
                                textStyle: const TextStyle(
  ...
  Future<String?> BuyDialog() => showDialog<String?>(
        ...
        builder: (context) => AlertDialog(
          ...
          content: TextFormField(
            ...
            decoration:
                InputDecoration(hintText: 'Current stock: ${itemModel.qty}'),
          ),
          actions: [
            TextButton(
              child: Text(
            ...
            TextButton(
              ...
              ), //() async{//Navigator.of(context).pop(quantity.text);quantity.clear();}
            ),
          ],
        ),
      );
  ...
  Future Ssubmit() async {
    ...
    var earnings = (double.parse(Isell!) - double.parse(Ibuy!)) *
